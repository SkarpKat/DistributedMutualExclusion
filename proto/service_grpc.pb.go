...
const (
	Service_Request_FullMethodName = "/Service.Service/Request"
)
...
func (c *serviceClient) Request(ctx context.Context, in *RequestMessage, opts ...grpc.CallOption) (*ResponseMessage, error) {
...
func (UnimplementedServiceServer) Request(context.Context, *RequestMessage) (*ResponseMessage, error) {
...
func _Service_Request_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).Request(ctx, req.(*RequestMessage))
	}
